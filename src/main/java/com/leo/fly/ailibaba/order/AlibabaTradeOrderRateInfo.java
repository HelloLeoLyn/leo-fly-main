...
import com.alibaba.trade.param.AlibabaOrderRateDetail;
...
public class AlibabaTradeOrderRateInfo {
    ...
    private com.alibaba.trade.param.AlibabaOrderRateDetail[] buyerRateList;

    /**
     * @return 卖家給买家的评价
     */
    public com.alibaba.trade.param.AlibabaOrderRateDetail[] getBuyerRateList() {
     ...
     * 此参数必填
     */
    public void setBuyerRateList(com.alibaba.trade.param.AlibabaOrderRateDetail[] buyerRateList) {
        this.buyerRateList = buyerRateList;
    }

    private com.alibaba.trade.param.AlibabaOrderRateDetail[] sellerRateList;

    /**
     * @return 买家給卖家的评价
     */
    public com.alibaba.trade.param.AlibabaOrderRateDetail[] getSellerRateList() {
