...
public class SendMail {
    ...
    public static String myEmailAccount = "2864672058@qq.com";
    public static String myEmailPassword = "kdfqkwloxdigdffe";
    public static String myEmailPassword2 = "zjalkjfkisqqdhae";
//    public static String myEmailPassword = "lyx1858775";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "541124712@qq.com";
