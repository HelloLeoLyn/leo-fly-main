...
import com.leo.fly.common.constant.Constant;
import com.leo.fly.common.util.MD5Util;
import com.leo.fly.web.annotation.SignNew;
...
　 * @version 1.0
 */
public class SignNewValidator implements ConstraintValidator<SignNew, Object> {
	private static Logger log = LoggerFactory.getLogger(SignNewValidator.class);
	private String[] signFields;
	private String signField;
	@Value("${session.active: true}")
	private boolean doIt;
	@Override
	public void initialize(SignNew sign) {
	...
	private boolean impl(Object obj) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
		...
		sb.append(Constant.TOKEN_AES_KEY);
